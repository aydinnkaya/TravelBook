...
import com.aydinkaya.travelbooks.databinding.ActivityMapsBinding
import com.aydinkaya.travelbooks.model.Place
import com.aydinkaya.travelbooks.roomdb.PlaceDao
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = getSharedPreferences(" com.aydinkaya.travelbooks", MODE_PRIVATE)
        trackBoolean = false


        db = Room.databaseBuilder(  // database initializing
            applicationContext,
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (info == "new") {
            ...
            mMap.clear()
            placeFromMain = intent.getSerializableExtra("place",Place::class.java)
            placeFromMain?.let {
    ...
    fun save(view: View?) {
        ...
        mDisposable.add(placeDao.insert(place)
            .subscribeOn(Schedulers.io()) // abonne ol
            .observeOn(AndroidSchedulers.mainThread()) // gözlemlenebilir
            .subscribe(this::handleResponse)) // bitince bu foksiyon çalıştıralaccak referans
    }
